...
//Небезопастный вызов - возможна утечка памяти
    ...
    [[session dataTaskWithURL:[NSURL URLWithString:item.gameImgUrl]
            completionHandler:^(NSData *data,
                                NSURLResponse *response,
                                NSError *error) {
                currentCell.gameImg.image = [UIImage imageWithData:data];
                /*[currentCell.gameImg setImageWithURL:[NSURL URLWithDataRepresentation: data relativeToURL:item.gameImgUrl ]
